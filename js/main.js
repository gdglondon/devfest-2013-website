var devfest = angular.module('DevFest',['ngSanitize']).
    config(function($routeProvider){
        $routeProvider.
            when('/', {
                "templateUrl" : "/static/devfest/views/home.html",
                "controller" : "HomeControl"
            }).
            when('/news', {
                "templateUrl" : "/static/devfest/views/news.html",
                "controller" : "NewsControl"
            }).
            when('/schedule', {
                "templateUrl" : "/static/devfest/views/schedule.html",
                "controller" : "ScheduleControl"
            }).
            when('/speakers', {
                "templateUrl" : "/static/devfest/views/speakers.html",
...
devfest.controller('NewsControl', function($scope, $http, Language){
    $scope.Language = Language;
    $http.
        jsonp('https://www.googleapis.com/plus/v1/activities?query=gdg+london&callback=JSON_CALLBACK&key=AIzaSyDssVSRzwj0vX4K3XsCVKJ-2LxCzXeiaNw').
...
devfest.controller('ScheduleControl', function($scope, $http, Language){
    $scope.Language = Language;
    $http.
        get('/static/devfest/json/schedule.json').
        success(function(response){
            $scope.schedule = response;
            $http.
                get('/static/devfest/json/speakers.json').
                success(function(response){
